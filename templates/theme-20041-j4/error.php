...
<?php $heading_tag = $params->get('Site_Title_Heading_Tag');?>
<<?php echo $heading_tag; ?> class="ttr_title_style">
<a href="<?php echo $app->getCfg('live_site');?>" style="font-size:<?php echo $params->get('Site_Title_FontSize'); ?>px;">
Simplex
</a>
...
<?php
$showright= count(JModuleHelper::getModules('right'));
if($showright){
?>
<div id="ttr_content">
<?php
